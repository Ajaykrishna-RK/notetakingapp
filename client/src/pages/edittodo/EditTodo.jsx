...
import { EditTodoApi } from '../../redux/fetchingApi/editTodoApi'
import { useNavigate } from 'react-router-dom'

function EditTodo({singleTodo,id,setEditOpen}) {
...
e.preventDefault()
dispatch(EditTodoApi({id,editTodo}))
navigate('/')
...
<h1 className="text-6xl text-white">EDIT YOUR NOTE</h1>
